...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_aws_utils__ = __webpack_require__(5);
...
/* harmony default export */ __webpack_exports__["default"] = (async ctx => {
  ...
  try {
    const {user} = ctx.meta
    const {bucketName, region} = await Object(__WEBPACK_IMPORTED_MODULE_2_aws_utils__["a" /* awsDefaultS3Context */])(ctx)
    const {name} = ctx.args
    ...
    const s3instance = Object(__WEBPACK_IMPORTED_MODULE_2_aws_utils__["b" /* s3 */])({ctx, region})
